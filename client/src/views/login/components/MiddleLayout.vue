<!--
 * @Author: yiwen.wu
 * @Date: 2021-07-22 14:29:17
 * @LastEditTime: 2022-01-05 17:03:26
 * @LastEditors: xin.chen
 * @Description: 居中风格的登录页面
 * @FilePath: /ks-vue-template/src/views/Login/components/MiddleLayout.vue
-->
<template>
...
export default {
  name: 'MiddleLayoutComponent',
  mixins: [loginMixin],
  data() {
    return {
      backgroundImage: require(`@assets/image/login/bgM${Math.round(Math.random() * 2 + 1)}.png`)
    }
  },
  methods: {
    imageBgStyle() {
...
.login__form {
  ...
  padding: 70px 100px;
  border-radius: 8px;
  box-shadow: 0px 20px 40px 0px rgba($--color-000,0.30);
}
